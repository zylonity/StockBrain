        ...
        if settings.research_enabled and settings.active_llm_api_key.get_secret_value():
            ...
            try:
                ...
                self.research = ResearchService(
                    ...
                    company_cooldown_hours=settings.research_company_cooldown_hours,
                    cooldown_bypass_importance=settings.research_cooldown_bypass_importance,
                    skip_event_types=tuple(settings.research_skip_event_types),
                    max_event_age_hours=settings.research_max_event_age_hours,
